...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("global", "Global", "open_permissions_popup", "Open the permissions popup."),
    ...
    action("chat", "Chat", "set_reasoning_effort_low", "Set reasoning effort to low."),
    action("chat", "Chat", "set_reasoning_effort_medium", "Set reasoning effort to medium."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("global", "open_permissions_popup") => Some(&mut keymap.global.open_permissions_popup),
        ...
        ("chat", "set_reasoning_effort_low") => Some(&mut keymap.chat.set_reasoning_effort_low),
        ("chat", "set_reasoning_effort_medium") => Some(&mut keymap.chat.set_reasoning_effort_medium),
        ("chat", "set_reasoning_effort_high") => Some(&mut keymap.chat.set_reasoning_effort_high),
        ("chat", "set_reasoning_effort_xhigh") => Some(&mut keymap.chat.set_reasoning_effort_xhigh),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("chat", "set_reasoning_effort_low") => Some(runtime_keymap.chat.set_reasoning_effort_low.as_slice()),
        ("chat", "set_reasoning_effort_medium") => Some(runtime_keymap.chat.set_reasoning_effort_medium.as_slice()),
        ("chat", "set_reasoning_effort_high") => Some(runtime_keymap.chat.set_reasoning_effort_high.as_slice()),
        ("chat", "set_reasoning_effort_xhigh") => Some(runtime_keymap.chat.set_reasoning_effort_xhigh.as_slice()),
